...
```
- [H1](1. **Identify where a UCE loci is found in the genome**)
- [H2](1a. **baltq.sh the probes** to find where they are hiding in the "base genome")
- [H3](2. Now we are going to **insert introns into the general feature format (GFF) file** of the "base genome")
- [H4](3. **Match the results from blastq with genomic GFF data**)
- [H5](3a. **Writing the files you have identified to concatenate by gene**)
- [H6](4. **Organizing files for phylogentic analyses**)
- [H7](5. **Round up the bootstrap files paths and best tree files for ASTRAL**)
